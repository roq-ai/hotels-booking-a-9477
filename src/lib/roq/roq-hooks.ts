...
export function usePropertyFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['usePropertyFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.property.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePropertyCount<T extends Prisma.propertyCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.propertyCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['usePropertyCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.property.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePropertyFindManyWithCount<
  T extends Prisma.propertyFindManyArgs,
  R extends { data: GetFindResult<Prisma.$propertyPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.propertyFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['usePropertyFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.property.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePropertyFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['usePropertyFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.property.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
