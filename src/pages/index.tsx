  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience convenience with Hotels Booking Application - your gateway to great hotel and apartment deals, ready to be booked in just a few minutes."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1590073844006-33379778ae09?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxob3RlbHxlbnwwfHx8fDE2OTgwNjMwNjV8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience convenience with Hotels Booking Application - your gateway to great hotel and apartment deals, ready to be booked in just a few minutes.`}
            </Text>
            <Box
