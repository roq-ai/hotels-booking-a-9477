...
import { useRoqPlatformUserProfiles, usePropertyCount, useBookingCount, useReviewCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const propertyStat = usePropertyCount();
