...
import { useRoqClient, usePropertyFindManyWithCount } from 'lib/roq';
...
export function PropertyListPage(props: PropertyListPageProps) {
  ...
  const { data, error, isLoading, mutate } = usePropertyFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.property.delete({ where: { id } });
      await mutate();
    } catch (error) {
